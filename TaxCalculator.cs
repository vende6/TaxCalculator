...
namespace TaxCalculatorInterviewTests
{
    ...
    public class TaxCalculator : ITaxCalculator
    {
        ...
        public void SetCustomTaxRate(Commodity commodity, double rate)
        {
            ...
            //if (!_customRates.Any() || (_customRates.Where(x => x.Item1 == commodity && x.Item2 == DateTime.Now)).Any())
            //{
            //    return;
            //}
            int i = (int)commodity;
            _customRates[0] = new Tuple<Commodity,DateTime,double>(commodity, DateTime.Now, rate);
        }
